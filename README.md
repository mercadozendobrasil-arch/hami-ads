...
- Mercado Livre、Shopee、TikTok Ads 账户统一接入
...
- [平台接入说明](docs/INTEGRATIONS.md)
- [第一阶段实现 Prompt](prompts/PHASE-1.md)
- [公开参考与设计边界](docs/SOURCES.md)

## V1 第一阶段边界

第一阶段交付一个供公司内部使用的“利润驾驶舱”：完成用户、店铺/广告账户、商品/SKU、广告数据、订单与成本数据的接入和标准化，提供利润分析、广告诊断、建议队列和审批流。
...
3. Internal-first：单公司部署，数据边界由内部用户角色和服务端权限控制。
